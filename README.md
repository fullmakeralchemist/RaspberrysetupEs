...
En caso de que te interese puedes revisar la [guia de como instalar Visual Studio Code y Git en Raspberry Pi](https://github.com/fullmakeralchemist/gitvscode).
